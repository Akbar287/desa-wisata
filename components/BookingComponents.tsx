  ...
  return (
    <div
      style={{
        ...
        height: 40,
        borderRadius: "50%",
        background: "linear-gradient(135deg, var(--color-primary), #2d8f5e)",
        display: "flex",
        alignItems: "center",
...
const TERMS_CONTENT = [
  {
    title: "Pemesanan & Konfirmasi",
    text: "Pemesanan dianggap sah setelah formulir diisi lengkap dan dikonfirmasi oleh tim kami melalui email atau telepon. Konfirmasi akan dikirimkan dalam 1×24 jam kerja.",
  },
  {
    title: "Pembayaran",
    text: "Pembayaran dapat dilakukan melalui transfer bank atau metode pembayaran lain yang tersedia. Uang muka sebesar 30% dari total biaya harus dibayarkan dalam 3 hari setelah konfirmasi pemesanan.",
  },
  {
    title: "Pelunasan",
    text: "Pelunasan penuh harus diselesaikan paling lambat 7 hari sebelum tanggal keberangkatan. Pemesanan akan otomatis dibatalkan jika pelunasan tidak diterima tepat waktu.",
  },
  {
    title: "Pembatalan oleh Peserta",
    text: "Pembatalan lebih dari 14 hari sebelum keberangkatan: pengembalian 80%. Pembatalan 7–14 hari sebelum: pengembalian 50%. Pembatalan kurang dari 7 hari: tidak ada pengembalian.",
  },
  {
    title: "Pembatalan oleh Penyelenggara",
    text: "Kami berhak membatalkan perjalanan karena alasan keamanan, cuaca buruk, atau jumlah peserta minimum tidak terpenuhi. Dalam hal ini, pengembalian penuh akan diberikan.",
  },
  {
    title: "Perubahan Jadwal",
    text: "Perubahan jadwal dapat dilakukan maksimal 10 hari sebelum keberangkatan, tergantung ketersediaan. Perubahan dapat dikenakan biaya administrasi.",
  },
  {
    title: "Tanggung Jawab Peserta",
    text: "Peserta wajib mematuhi peraturan setempat dan mengikuti arahan pemandu wisata. Peserta bertanggung jawab atas barang pribadi selama perjalanan.",
  },
  {
    title: "Asuransi Perjalanan",
    text: "Paket wisata telah mencakup asuransi perjalanan dasar. Peserta disarankan untuk mengambil asuransi tambahan sesuai kebutuhan pribadi.",
  },
  {
    title: "Dokumentasi",
    text: "Peserta wajib membawa identitas resmi (KTP/Paspor) yang masih berlaku selama perjalanan. Untuk wisata ke daerah tertentu, surat izin tambahan mungkin diperlukan.",
  },
  {
    title: "Force Majeure",
    text: "Kami tidak bertanggung jawab atas kerugian yang disebabkan oleh bencana alam, pandemi, kebijakan pemerintah, atau kondisi di luar kendali kami.",
  },
  {
    title: "Persetujuan",
    text: "Dengan melanjutkan pemesanan, peserta dianggap telah membaca, memahami, dan menyetujui seluruh syarat dan ketentuan yang berlaku.",
  },
];
...
const PRIVACY_CONTENT = [
  {
    ...
    text: "Kami mengumpulkan data pribadi seperti nama lengkap, email, nomor telepon, tanggal lahir, dan kewarganegaraan yang Anda berikan saat mengisi formulir pemesanan.",
  },
  {
    title: "Tujuan Penggunaan Data",
    text: "Data pribadi Anda digunakan untuk memproses pemesanan, menghubungi Anda terkait perjalanan, memberikan layanan pelanggan, dan mengirimkan informasi terkait wisata.",
  },
  {
    title: "Penyimpanan Data",
    text: "Data Anda disimpan secara aman dengan enkripsi standar industri. Kami menyimpan data selama diperlukan untuk tujuan pemesanan dan sesuai dengan peraturan yang berlaku.",
  },
  {
    title: "Berbagi Data",
    text: "Kami tidak menjual atau menyewakan data pribadi Anda kepada pihak ketiga. Data hanya dibagikan kepada mitra operasional (hotel, transportasi) sejauh diperlukan untuk layanan.",
  },
  {
    title: "Keamanan Data",
    text: "Kami menerapkan langkah-langkah keamanan teknis dan organisasi untuk melindungi data pribadi Anda dari akses tidak sah, perubahan, pengungkapan, atau penghancuran.",
  },
  {
    title: "Hak Pengguna",
    text: "Anda berhak meminta akses, koreksi, atau penghapusan data pribadi Anda. Hubungi kami melalui email untuk mengajukan permintaan terkait data Anda.",
  },
  {
    title: "Cookie & Analitik",
    text: "Website kami menggunakan cookie untuk meningkatkan pengalaman pengguna. Anda dapat mengatur preferensi cookie melalui pengaturan browser Anda.",
  },
  {
    title: "Perubahan Kebijakan",
    text: "Kebijakan privasi ini dapat diperbarui sewaktu-waktu. Perubahan signifikan akan diberitahukan melalui email atau notifikasi di website kami.",
  },
];
            ...
            {items.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  gap: 14,
                  padding: "16px 18px",
                  background: i % 2 === 0 ? "var(--color-bg-light)" : "white",
                  borderRadius: "var(--radius-md)",
    ...
    <>
      ...
      <div
        style={{
          ...
          textAlign: "center",
          background:
            "linear-gradient(180deg, var(--color-bg-light) 0%, white 100%)",
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "linear-gradient(135deg, rgba(26,92,56,0.1), rgba(45,143,94,0.15))",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            marginBottom: 28,
        ...
        >
          <svg
            ...
            strokeLinejoin="round"
          >
            <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7v4m-2-2h4" />
          </svg>
        </div>
        <h2
          style={{
        ...
        >
          Untuk melakukan pemesanan, silakan pilih paket wisata dan jadwal
          keberangkatan terlebih dahulu.
        </p>
        <Link
          href="/tours"
          className="btn-primary"
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      <label style={labelStyle}>
        Pilih Tanggal Booking <span style={{ color: "#DC2626" }}>*</span>
      </label>
      <div
        style={{
          border: dateError
        ...
        >
          <button
            ...
            style={{
              ...
              borderRadius: "50%",
              border: "none",
              background: canGoPrev ? "var(--color-bg-light)" : "transparent",
              ...
              <button
                ...
                title={
                  isPast
                    ? "Sudah lewat"
                    : isFull
                      ? `Penuh (${booked}/${dailyQuota})`
                      : `${booked}/${dailyQuota} terisi`
                }
                style={{
                  width: "100%",
                  aspectRatio: "1",
                  ...
                  border: isSelected
                    ...
                    : `1.5px solid ${isPast ? "transparent" : colors.border + "40"}`,
...
function BookingForm({
  ...
  const effectiveStartDate =
    needsCalendar && selectedDate
      ? fmtDateId(new Date(selectedDate))
      : startDate;
  const effectiveEndDate =
    needsCalendar && selectedDate ? fmtDateId(new Date(selectedDate)) : endDate;
  ...
  return (
    <>
      ...
      <section
        style={{
          background:
            "linear-gradient(135deg, #0d3b22 0%, var(--color-primary-dark) 30%, var(--color-primary) 65%, #2d8f5e 100%)",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        s.num <= 2 ? "white" : "rgba(255,255,255,0.12)",
                      color:
                        s.num <= 2
                          ? "var(--color-primary)"
                  ...
                  <span
                    style={{
                      fontSize: 13,
                      fontWeight: s.num === 2 ? 700 : 400,
                      color: s.num <= 2 ? "white" : "rgba(255,255,255,0.5)",
                      fontFamily: "var(--font-body)",
                      whiteSpace: "nowrap",
                    }}
                  >
                ...
                {i < steps.length - 1 && (
                  <div
                    style={{
                      width: 40,
                      height: 2,
                      background: s.num < 2 ? "white" : "rgba(255,255,255,0.2)",
                      margin: "0 12px",
                      flexShrink: 0,
                    }}
                  />
      ...
      {/* Form */}
      <main
        style={{ maxWidth: 1320, margin: "0 auto", padding: "48px 24px 80px" }}
      >
        <div
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Isi sesuai dengan identitas resmi Anda
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <label style={labelStyle}>
                    Nama Belakang <span style={{ color: "#DC2626" }}>*</span>
                  </label>
                  <input
                    name="lastName"
                    value={form.lastName}
                  ...
                  {[
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background:
                          form.gender === v ? "var(--color-bg-light)" : "white",
                        color:
                          form.gender === v
                            ? "var(--color-primary)"
                ...
                >
                  <div>
                    <select
                      ...
                      style={{
                        ...inputStyle,
                        borderColor: errors.birthYear ? "#DC2626" : undefined,
                      }}
                    >
                  ...
                  <div>
                    <select
                      ...
                      style={{
                        ...inputStyle,
                        borderColor: errors.birthMonth ? "#DC2626" : undefined,
                      }}
                    >
                  ...
                  <div>
                    <select
                      ...
                      style={{
                        ...inputStyle,
                        borderColor: errors.birthDay ? "#DC2626" : undefined,
                      }}
                    >
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <select
                  ...
                  style={{
                    ...inputStyle,
                    borderColor: errors.nationality ? "#DC2626" : undefined,
                  }}
                >
            ...
            >
              ...
              >
                <div>
                  <label style={labelStyle}>
                    Jumlah Dewasa <span style={{ color: "#DC2626" }}>*</span>
                  </label>
                  <input
                    name="adults"
                    type="number"
                    ...
                    style={{
                      ...inputStyle,
                      borderColor: errors.adults ? "#DC2626" : undefined,
                    }}
                  />
              ...
              <div
                style={{
                  background:
                    "linear-gradient(135deg, rgba(26,92,56,0.06), rgba(45,143,94,0.1))",
                  borderRadius: "var(--radius-md)",
                  padding: "18px 22px",
                  marginBottom: 20,
                  display: "flex",
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <select
                  name="findUs"
                  value={form.findUs}
                  onChange={(e) => set("findUs", e.target.value)}
                  style={{
                    ...inputStyle,
                    borderColor: errors.findUs ? "#DC2626" : undefined,
                  }}
                >
              ...
              <div>
                <label style={labelStyle}>
                  Pertanyaan atau catatan (opsional)
                </label>
                <textarea
                  name="comments"
                  value={form.comments}
                  ...
                  rows={4}
                  placeholder="Ada permintaan khusus? Diet tertentu? Alergi?"
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    flexShrink: 0,
                    marginTop: 1,
                    border: form.acceptTerms
                      ? "2px solid var(--color-primary)"
                      : errors.acceptTerms
                        ? "2px solid #DC2626"
                        : "2px solid #D1D5DB",
                    background: form.acceptTerms
                      ? "var(--color-primary)"
                      : "white",
                    display: "flex",
                    alignItems: "center",
          ...
          <aside
            ...
            style={{ width: 340, flexShrink: 0, position: "sticky", top: 140 }}
          >
            <div
              style={{
                background: "white",
            ...
            >
              ...
              >
                {[
                  {
                    l: needsCalendar ? "Tanggal Booking" : "Berangkat",
                    v: effectiveStartDate || "—",
                  },
                  ...(!needsCalendar
                    ? [{ l: "Kembali", v: effectiveEndDate }]
                    : []),
              ...
              >
                💡 Harga final tergantung jumlah peserta dalam grup. Tim kami
                akan mengkonfirmasi setelah pemesanan.
              </div>
            </div>
          </aside>
        </div>
