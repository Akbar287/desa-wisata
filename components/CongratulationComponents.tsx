...
export default function CongratulationComponents({
  booking,
}: {
    ...
    return (
      <>
        ...
        >
          ...
          >
            Booking tidak ditemukan atau belum tersedia.
          </p>
          <Link
            href="/tours"
  ...
  const paidPayment =
    booking.payments.find((p) => p.status === "PAID") ?? booking.payments[0];
    ...
    <>
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: 2,
            background: "#FFD700",
            animation: "confetti1 2s ease-in infinite",
          }}
        />
        <div
          style={{
            ...
            borderRadius: "50%",
            background: "#FF6B6B",
            animation: "confetti2 2.5s ease-in infinite 0.5s",
          }}
        />
        <div
          style={{
            ...
            borderRadius: 2,
            background: "#4ECDC4",
            animation: "confetti3 2.2s ease-in infinite 0.3s",
          }}
        />
        <div
          style={{
            ...
            borderRadius: 2,
            background: "#A78BFA",
            animation: "confetti1 2.8s ease-in infinite 0.7s",
          }}
        />
        <div
          style={{
            ...
            borderRadius: 2,
            background: "#F472B6",
            animation: "confetti2 2.4s ease-in infinite 0.2s",
          }}
        />
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", position: "relative" }}>
          ...
          >
            Pembayaran Anda telah kami terima. Tim kami akan segera
            memverifikasi dan menghubungi Anda.
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          ...
          >
            Simpan kode ini sebagai referensi pembayaran Anda
          </p>
        </div>
            ...
            {(
              [
                ...
                booking.tour
                  ? {
                      l: "Tanggal",
                      v: `${fmtDate(booking.startDate)} — ${fmtDate(booking.endDate)}`,
                    }
                  : { l: "Tanggal Kunjungan", v: fmtDate(booking.startDate) },
                booking.tour
                ...
                {
                  l: "Telepon",
                  v: `${booking.phoneCode} ${booking.phoneNumber}`,
                },
                {
                  l: "Peserta",
                ...
                {
                  l: "Metode Pembayaran",
                  v: paidPayment?.paymentAvailable?.name ?? "-",
                },
                {
                  l: "Tanggal Bayar",
                  v: paidPayment?.paidAt
                    ? fmtDate(paidPayment.paidAt)
          ...
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg, rgba(37,211,102,0.1), rgba(37,211,102,0.2))",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                margin: "0 auto 16px",
            ...
            >
              Bergabung untuk info terbaru perjalanan Anda
            </p>
            <a
              href={WA_GROUP_LINK}
              target="_blank"
        ...
        >
          ...
          <div>
            ...
            >
              <li>
                Tim kami akan memverifikasi pembayaran dalam{" "}
                <strong>1×24 jam</strong>
              </li>
              <li>
                E-ticket dan detail perjalanan akan dikirim ke{" "}
