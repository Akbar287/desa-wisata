    ...
    <main>
      <section className="relative pt-20 min-h-[460px] flex items-center overflow-hidden">
        ...
        <div className="relative z-2 w-full max-w-[900px] mx-auto px-6 py-16 text-center">
          ...
          >
            Punya pertanyaan tentang paket wisata, akomodasi, atau ingin
            berkunjung? Tim kami siap membantu Anda merencanakan pengalaman
            wisata terbaik di Desa Manud Jaya.
          </motion.p>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          >
            <motion.div variants={fadeUp} className="text-center mb-12">
              ...
              >
                Temukan kami di jantung Desa Manud Jaya, dikelilingi pemandangan
                alam pegunungan Bandung Barat yang menakjubkan.
              </p>
              <div
                  ...
                  <div className="flex flex-col gap-5">
                    {[
                      ...
                      <div key={item.label} className="flex items-start gap-3">
                        ...
                        <div>
                          <span
                            className="font-sans text-xs font-semibold uppercase tracking-wider block mb-1"
                            style={{ color: "var(--color-text-muted)" }}
                          >
                            {item.label}
                          </span>
                          <p
                            className="font-sans text-sm leading-relaxed m-0 whitespace-pre-line"
                            style={{ color: "var(--color-text)" }}
                          >
                            {item.value}
                          </p>
          ...
          >
            <motion.div variants={fadeUp} className="text-center mb-12">
              ...
              <p
                ...
                style={{ color: "var(--color-text-muted)" }}
              >
                Pilih kanal komunikasi yang paling nyaman untuk Anda. <br />{" "}
                Kami siap melayani melalui berbagai platform.
              </p>
              <div
                className="w-16 h-1 rounded-full mx-auto mt-5"
                style={{
              ...
              {contactChannels.map((channel) => (
                ...
                >
                  ...
                  <div className="p-6 text-center">
                    ...
                    <h3
                      className="font-serif text-base font-bold mb-1 transition-colors duration-300"
                      style={{ color: "var(--color-text)" }}
                    >
                      {channel.title}
                    </h3>
                    <p
                      className="font-sans text-sm font-semibold mb-2 m-0"
                      style={{ color: "var(--color-primary)" }}
                    >
                      {channel.value}
                    </p>
                    <p
                      className="font-sans text-[12px] leading-relaxed m-0"
                      style={{ color: "var(--color-text-muted)" }}
                    >
                      {channel.desc}
                    </p>
        ...
        <div className="max-w-[900px] mx-auto text-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ color: "var(--color-text-muted)" }}
            >
              Beberapa hal yang perlu diketahui sebelum menghubungi atau
              mengunjungi kami.
            </motion.p>
            ...
            >
              {[
                ...
                },
                {
                  emoji: "⚡",
                  title: "Respon Cepat",
                  desc: "WhatsApp dibalas\nmaksimal 1 jam",
                },
                {
                  emoji: "🎫",
                  title: "Reservasi",
                  desc: "Booking minimal\n3 hari sebelumnya",
                },
                {
                  emoji: "🚗",
                  title: "Akses Lokasi",
                ...
                >
                  ...
                  <p
                    className="font-sans text-[13px] leading-relaxed m-0 whitespace-pre-line"
                    style={{ color: "var(--color-text-muted)" }}
                  >
                    {v.desc}
                  </p>
      ...
      <section className="relative overflow-hidden py-16 px-6">
        ...
        >
          ...
          <p className="font-sans text-sm text-white/80 mb-6 leading-relaxed">
            Jangan ragu untuk menghubungi kami. Tim kami dengan senang hati akan
            membantu Anda merencanakan perjalanan wisata yang sempurna ke Desa
            Manud Jaya.
          </p>
