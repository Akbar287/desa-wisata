...
const s = StyleSheet.create({
  ...
  refundWrap: {
    marginTop: 8,
    borderTop: `1 dashed ${LIGHT_BORDER}`,
    paddingTop: 8,
  },
  refundLabel: {
    fontSize: 7,
  ...
  refundUrl: { fontSize: 7, color: "#1D4ED8" },
  // Bottom stripe
  stripe: {
    position: "absolute",
    bottom: 0,
        ...
        <View style={s.body}>
          ...
          <View style={s.sectionBox}>
            {[
              {
                l: "Nama Lengkap",
                v: `${booking.firstName} ${booking.lastName}`,
              },
              ...
              <View style={s.sectionBox}>
                {[
                  { l: "Metode", v: payment.paymentAvailable?.name ?? "-" },
                  {
                    l: "Tipe",
                    v:
                      typeLabels[payment.paymentAvailable?.type] ??
                      payment.paymentAvailable?.type ??
                      "-",
                  },
                  {
                    l: "No. Rekening / Akun",
                    v: payment.paymentAvailable?.accountNumber ?? "-",
                  },
                  {
                    l: "Atas Nama",
                    v: payment.paymentAvailable?.accountName ?? "-",
                  },
                ].map((r, i, arr) => (
                  <View
                    key={r.l}
          ...
          >
            ...
            <Text style={{ fontSize: 6.5, color: "#92400E", lineHeight: 1.5 }}>
              Dokumen ini adalah bukti pembayaran yang sah. Simpan dokumen ini
              dengan baik. E-ticket dan detail perjalanan akan dikirimkan ke
              email Anda setelah pembayaran diverifikasi oleh tim kami.
            </Text>
          </View>
        ...
        <View style={s.footer}>
          <View style={s.footerLeft}>
            <Text style={s.footerText}>
              Dokumen ini digenerate secara otomatis oleh sistem Desa Manud
              Jaya.
            </Text>
            <Text style={s.footerText}>
              Untuk pertanyaan, hubungi: support@desa-wisata-ui.vercel.app | +62
              812-3456-7890
            </Text>
          </View>
          <View style={s.footerRight}>
            ...
            <Text style={s.footerTagline}>
              Jelajahi Keindahan Desa Indonesia
            </Text>
          </View>
        </View>
