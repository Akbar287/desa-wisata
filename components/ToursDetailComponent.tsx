...
export default function ToursDetailComponent({
  tour,
  navItems,
  relatedTours,
}: {
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-2 mb-4">
              {tour.themes.map((t) => (
                <span
                  key={t}
                  className="px-4 py-1.5 rounded-full text-xs font-sans font-semibold text-white bg-white/15 backdrop-blur-sm border border-white/20 tracking-wide"
                >
                  {t}
                </span>
              ))}
          ...
          <div className="flex-1 min-w-0 w-full">
              ...
              >
                {tour.dates.map((d, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="rounded-2xl p-5 flex flex-col gap-3 transition-shadow duration-300 hover:shadow-lg"
                      style={{
                        background: "var(--color-white)",
                        border: "1px solid var(--color-border-subtle)",
                      }}
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          <div
                            className="font-sans text-xs uppercase tracking-wider font-semibold mb-1"
                            style={{ color: "var(--color-text-muted)" }}
                          >
                            Berangkat
                          </div>
                      ...
                      >
                        ...
                        <Link
                          href={`/booking?id=${tour.id}&start=${d.start}&end=${d.end}&jenis=paket-wisata`}
                        >
            ...
            >
              ...
              >
                ...
                >
                  <h4
                    className="font-sans text-sm font-bold uppercase tracking-wider mb-4"
                    style={{ color: "#10B981" }}
                  >
                    ✓ Termasuk
                  </h4>
                ...
                >
                  <h4 className="font-sans text-sm font-bold uppercase tracking-wider mb-4 text-red-600">
                    ✕ Tidak Termasuk
                  </h4>
                  <ul className="list-none p-0 m-0 flex flex-col gap-3">
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                {tour.goodToKnow.map((g, i) => (
                  ...
                  >
                    <h4
                      className="font-sans text-[15px] font-bold mb-2"
                      style={{ color: "var(--color-text)" }}
                    >
                      {g.title}
                    </h4>
              ...
              <div className="flex flex-col gap-5">
                {tour.reviews.map((r, i) => (
                  ...
                  >
                    ...
                    <p
                      className="font-sans text-sm leading-relaxed m-0 italic"
                      style={{
                        color: "var(--color-text-light)",
                        lineHeight: 1.7,
                      }}
          ...
          <aside className="tour-detail-sidebar hidden lg:block w-[310px] shrink-0 sticky top-[120px] pt-2">
            ...
            >
              ...
              <Link href={`/inquiry?id=${tour.id}`} className="block">
                <button className="btn-outline w-full justify-center py-3 px-6 mb-6 text-sm">
                  Tanya Kami
                </button>
              </Link>
          ...
          >
            ...
            <motion.button
              onClick={(e) => {
                e.stopPropagation();
                setLightboxIdx(
                  Math.min(tour.gallery.length - 1, lightboxIdx + 1),
                );
              }}
  ...
  return (
    ...
    >
      <button
        ...
        style={{
          background: open ? "var(--color-cream)" : "var(--color-white)",
        }}
      >
        <span
          ...
          style={{
            background: open
              ? dayGradients[index % dayGradients.length]
              : "var(--color-cream)",
