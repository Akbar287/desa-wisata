...
export default function WahanaSection({ wahana }: { wahana: Wahana[] }) {
    if (!wahana || wahana.length === 0) return null;
        ...
        >
            ...
            <div className="max-w-[1320px] mx-auto px-6 relative z-3">
                ...
                <div className="text-center mt-12">
                    <Link href="/wahana" className="btn-outline">
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 24 24"
