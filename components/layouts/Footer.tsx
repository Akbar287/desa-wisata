...
export default function Footer() {
    return (
        <footer
            id="contact"
            style={{
                background: "linear-gradient(180deg, var(--color-primary-dark) 0%, #0F1B15 100%)",
                color: "white",
                paddingTop: 80,
            }}
        >
            <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
                ...
                >
                    ...
                    >
                        Berlangganan newsletter kami untuk mendapatkan tips dan penawaran terbaik
                    </p>
                    <div
                        style={{
                            display: "flex",
                    ...
                    >
                        ...
                        />
                        <button className="btn-primary">Berlangganan</button>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        © 2026 Discover Desa Wisata. Hak cipta dilindungi.
                    </p>
