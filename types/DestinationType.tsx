...
export interface DestinationDetail {
    ...
    destinationAccessibilities: { accessibilityId: number; accessibility: { id: number; name: string } }[];
    destinationFacilities: { facilityId: number; facility: { id: number; name: string } }[];
}
